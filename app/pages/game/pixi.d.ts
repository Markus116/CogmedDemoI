...
export declare module PIXI
{
    ...
    hitTest(item:any, interactionData:InteractionData);
	}
  ...
  export /*declare*/ function requestAnimFrame( animate:()=>void );

}

export declare function setTimeOut(callback:Function, time:number);
