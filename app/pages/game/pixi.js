 ...
 */
/*window.*/PIXI.requestAnimFrame = (function() {
...
function /*PIXI.*/setTimeOut(callback, time) {
  console.log("pixi-setTimeOut");
...
PIXI.EventTarget = function () {
	...
	this.addEventListener = this.on = function ( type, listener ) { //Here
